    ...
    <div ref={containerRef} style={styles.container}>
      {phase === 'loading' ? (
        ...
        <div style={styles.welcomeWrap}>
          ...
          <h1 style={styles.welcomeTitle}>Ash's Drive</h1>
          <div style={styles.welcomeTagline}>Interactive Tesla Portfolio</div>
          ...
          <div style={styles.controlsGrid}>
            <div style={styles.controlItem}>
              ...
              <div>
                ...
                <div style={styles.controlDesc}>Click car parts to explore portfolio sections</div>
              </div>
            </div>
